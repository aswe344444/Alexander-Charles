...
public class JavaCode_GroupProject_02_WORKING {
    ...
    // filter field for searching names
    ...
    /**
     * Repopulate the list model using current tableModel rows.
     * If a search filter is present, only include rows whose first
     * column (name) contains the filter text (case insensitive).
     */
