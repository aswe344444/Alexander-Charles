...
void choice_back_door() 
{
   cout << "You check around back and find an unlocked back door. Do you go in?" << endl;
    cout << "1. Yes, go in." << endl;
    cout << "2. No, go home." << endl;
    int choice;
    cout << "Choose: ";
    cin >> choice;
    if (1 == choice) {
...
void choice_go_home() { cout << "You went home. The End!" << endl; }

void bad_end()
 {
    cout << "You didn't open the chest and missed out on the treasure. The End!" << endl;
  }
void good_end() 
  {
    cout << "You opened the chest and found a treasure! The End!" << endl;
  }

  void choice_go_in() 
  { 
  cout << "You went in the house. There is a treasure chest inside do you open it or not?" << endl;
  cout << "1. Open the chest." << endl;
  cout << "2. Don't open the chest." << endl;
  int choice;
  cout << "Choose: ";
  cin >> choice;
  if (1 == choice) 
